...
//----------------------------------------------------------------------------------------------------------------
		...
		//brazo 3 ---------------------------------------------------------------------------------------------
		model = glm::translate(model, glm::vec3(0.0f, -5.0f, 0.0f)); //por qué -5?

		modelaux = model;
		model = glm::scale(model, glm::vec3(2.0f, 10.0f, 2.0f)); //por qué esos valores??
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//articulacion 4 para la canasta-------------------------------------------------------------------------------
