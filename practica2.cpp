...
#include <glfw3.h>
//glm
#include<glm.hpp> //biblioteca matemática para uso de matrices
...
{
	GLfloat vertices_letras[] = {	 //Aquí se agregarán nuestras iniciales para el reporte 2
			//X			Y			Z			R		G		B
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//model = glm::rotate(model, glm::radians(angulo), glm::vec3(0.0f, 1.0f, 0.0f)); //se pegó esta linea nueva para que el cubo rote
		...
		*/
		...
		//meshList[0]->RenderMesh(); //Aquí imprime las cosas 3D (cubo o pirámide)
